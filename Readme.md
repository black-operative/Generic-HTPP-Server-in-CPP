...
1. HTTP Clone
    ...
    ```bash
    git clone https://github.com/black-operative/Generic-HTPP-Server-In-CPP.git
    ```
...
2. GitHub Desktop
    ...
    - Repo URL ***or*** Username + Repo name :  
        - `https://github.com/black-operative/Generic-HTTP-Server-In-CPP.git`
        - `black-operative/Generic-HTTP-Server-In-CPP`
